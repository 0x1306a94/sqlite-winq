...
#define SQLITE_WINQ_SYNTHESIZE_IMP(CLASS, propertyName, columnName)                                                           \
    const SQLITEWINQ::Property &CLASS::propertyName() {                                                                       \
        static const SQLITEWINQ::Property s_propertyName{                                                                     \
            columnName,                                                                                                       \
            SQLITE_WINQ_BINDING.addColumnBinding<SQLITE_WINQ_PROPERTY_TYPE(CLASS, propertyName)>(#propertyName, columnName)}; \
